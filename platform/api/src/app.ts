...
import { laserMaterialsRouter } from './routes/laser-materials.js';
import { premadeItemsRouter } from './routes/premade-items.js';
...
export function buildApp() {
  ...
  app.use(scannersRouter);
  app.use(laserMaterialsRouter);
  app.use(premadeItemsRouter);
