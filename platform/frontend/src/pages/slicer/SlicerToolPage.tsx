...
export function SlicerToolPage() {
  ...
  return (
    <div className="flex max-w-xl flex-col gap-4">
      <h1 className="text-2xl font-semibold text-slate-900">Slicer</h1>
      ...
      {lastResult && (
        <section className="flex flex-col gap-1 rounded border border-slate-200 p-4 text-sm">
          <h2 className="text-lg font-semibold text-slate-900">Last result</h2>
