...
|---|---|---|
| [`landing/`](landing/) | The public marketing site for barkie.co.za — 3 pages (Home, Pricing, Materials Guide) served by an Express app; Home/Pricing depend on two `platform/api` public endpoints, the Materials Guide runs on a static hand-curated dataset | Code-complete (built 2026-09-09), **not yet deployed** — the coming-soon page (`barkie-landing.service` on the VPS, deployed 2026-09-07) is still what's live; see `docs/AI_HANDOFF.md`. |
