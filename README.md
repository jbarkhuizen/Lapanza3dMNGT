...
| [`platform/frontend/`](platform/frontend/) | The subscriber dashboard SPA — React/Vite/TS/Tailwind, talks to `platform/api/` | Merged to `master`, pushed to GitHub, **live** at https://barkie.co.za/app/. Auth, app shell, every reference-data module, and Costing Templates done. Quotes, Invoices still unbuilt. |
